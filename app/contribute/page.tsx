...
export default function ContributePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-cream via-white to-brand-gold/10">
      <HeroBanner title="Contribute" description="Support Sri Bhuvaneswari Peetham" height="small" />
      <div className="max-w-5xl mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          ...
          <p className="text-black/70 mt-2">Multi‑step donation</p>
        </a>
        <a
        ...
        >
          ...
          <p className="text-black/70 mt-2">Donate to support the yatra</p>
        </a>
        <a
        ...
        >
          ...
          <p className="text-black/70 mt-2">Offer seva or pooja</p>
        </a>
      </div>
