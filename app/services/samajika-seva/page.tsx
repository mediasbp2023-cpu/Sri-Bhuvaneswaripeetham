    ...
    <div className="min-h-screen bg-gradient-to-br from-[#FFFFF0] via-[#FFF8DC] to-[#F5E6D3]">
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-[#800000] mb-6">Samajika Seva</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <div className="bg-white rounded-xl shadow-lg p-6 border border-[#FFD700]/20">
            <h3 className="text-xl font-semibold text-[#800000] mb-4">Community Development</h3>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-[#FFD700]/20">
            <h3 className="text-xl font-semibold text-[#800000] mb-4">Educational Support</h3>
            <p className="text-gray-700 mb-4">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-[#FFD700]/20">
            <h3 className="text-xl font-semibold text-[#800000] mb-4">Healthcare Services</h3>
            <p className="text-gray-700 mb-4">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-12 border border-[#FFD700]/20">
          <h2 className="text-3xl font-bold text-[#800000] mb-6">Our Impact</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
            ...
            <div className="p-4">
              <div className="text-3xl font-bold text-[#800000] mb-2">50+</div>
              <div className="text-gray-700">Villages Adopted</div>
            </div>
            <div className="p-4">
              <div className="text-3xl font-bold text-[#800000] mb-2">5000+</div>
              <div className="text-gray-700">Students Educated</div>
            </div>
            <div className="p-4">
              <div className="text-3xl font-bold text-[#800000] mb-2">100+</div>
        ...
        <div className="bg-[#FFF8DC] rounded-xl p-8 text-center">
          <h2 className="text-2xl font-semibold text-[#800000] mb-4">Join Our Social Service</h2>
          <p className="text-gray-700 mb-6">
            Be part of our community service initiatives and make a positive impact.
          </p>
          <div className="flex justify-center space-x-4">
            <button className="bg-gradient-to-r from-[#FFD700] to-[#FFA500] text-[#800000] px-6 py-3 rounded-lg font-semibold hover:from-[#FFA500] hover:to-[#FFD700] transition-all duration-300">
              Volunteer
            </button>
            <button className="bg-white text-[#800000] px-6 py-3 rounded-lg font-semibold border border-[#FFD700] hover:bg-[#FFF8DC] transition-colors">
              Donate
            </button>
          </div>
        </div>
