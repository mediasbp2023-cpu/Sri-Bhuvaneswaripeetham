...
export function Footer({ className = '' }: FooterProps) {
  ...
  return (
    <footer className={`bg-[#FFF8E7] text-[#800000] ${className}`}>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer">
                <Facebook className="h-6 w-6 hover:text-[#FFD700] transition-colors" />
              </a>
              <a href="https://www.youtube.com" target="_blank" rel="noopener noreferrer">
                <Youtube className="h-6 w-6 hover:text-[#FFD700] transition-colors" />
              </a>
            </div>
      ...
      <div className="bg-[#800000] text-[#FFFFF0] py-4">
